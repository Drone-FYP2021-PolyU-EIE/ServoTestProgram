...
class control_node(object):
    ...
    def gui(self):
        ...
        self.gripbt = tk.Button(conMode, text="Grip", width=10, bd=2, cursor="exchange", command = lambda: self.grip())
        self.gripbt.grid(row=0, column=3, columnspan=1)

        self.dropbt = tk.Button(conMode, text="Drop Crago", width=10, bd=2, cursor="exchange", command = lambda: self.drop())
        self.dropbt.grid(row=0, column=4, columnspan=1)
    ...
    def y_forward(self):
        self.ps.pose.position.x = self.local_pos_x
        self.ps.pose.position.y = (self.local_pos_y + 0.1)
        self.ps.pose.position.z = self.local_pos_z
        self.ps.pose.orientation.x = self.local_quat_x 
        self.ps.pose.orientation.y = self.local_quat_y
        self.ps.pose.orientation.z = self.local_quat_z
    ...
    def z_up(self):
        self.ps.pose.position.x = self.local_pos_x
        self.ps.pose.position.y = self.local_pos_y
        self.ps.pose.position.z = (self.local_pos_z + 0.1)
        self.ps.pose.orientation.x = self.local_quat_x 
        self.ps.pose.orientation.y = self.local_quat_y
        self.ps.pose.orientation.z = self.local_quat_z
        self.ps.pose.orientation.w = self.local_quat_w
